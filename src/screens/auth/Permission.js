        ...
        <View style={styles.container}>
            <View style={styles.main}>
                <View style={styles.sectionTop}>
                    ...
                    <Text style={styles.tlabel}>{'We need your permission to access your location and notifications - this helps us find players near you'}</Text>
                </View>
                <View style={styles.sectionMiddle}>
                    <View style={styles.item}>
                        <View>
                            <Image source={images.gps}></Image>
                        </View>
                    </View>
                    <View style={styles.item}>
                        <View>
