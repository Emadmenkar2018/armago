            ...
            <View style={styles.main}>
                ...
                <View style={styles.sectionMiddle}>
                    {this.state.profileSports.map((prop, key)=> {
                        ...
                        if(found.length == 0 ) this.state.ablity.push({sportId : prop.id, level: 'beginner'});
                        let _value = 0;
                        switch(value){
                          case  'beginner' : {
                            _value = 0;
                        ...
                        return (
                          <View key={prop.id} style={{marginVertical:5}}>
                            <View style={{ flexDirection: 'row',  alignItems: 'center'}}>
                                <Image source={{uri : prop.imageUrl}} style={styles.racket}/>
                            ...
                            <Slider
                                ...
                                onValueChange={val => {
                                  ...
                                  const elementIdx = this.state.ablity.findIndex(element => element.sportId == prop.id);
                                  ...
                                  newArray[elementIdx] = {...newArray[elementIdx], level : _level}
